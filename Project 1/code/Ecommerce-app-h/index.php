...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Swift Gift Center</title>
		 <link rel="icon" href="swifticon-white.png" sizes="32x32" type="image/png" sizes="50x50">
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				...
				<a href="index.php" class="navbar-brand">Swift Gift Center</a>
			</div>
