...
<script type="text/javascript">
  ...
  <title>Swift Marketplace | Products</title>
...
<body>
<header class="header">
            <a href="#" class="logo"><img src="../images/logo/swift.png" height="50px" alt="swift"><strong>Swift</strong></a> alt=""></a>
