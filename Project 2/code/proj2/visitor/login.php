...
<html>
    <head>
        ...
        <title>Swift Marketplace | Login</title>
        <link rel="icon" href="../images/logo/swifticon-white.png" sizes="32x32" type="image/png" sizes="50x50">
    </head>

    <body>    
        <header class="header">
            <a href="#" class="logo"><img src="../images/logo/swift.png" height="50px" alt="swift"><strong>Swift</strong></a>
...
<br>
<footer>
  <p>Copyright &copy; <script>document.write(new Date().getFullYear());</script>, Swift & Co LLC</p>
</footer>
</body>
<script>
var slideIndex = 0;
